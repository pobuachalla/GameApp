  ...
  document.getElementById('ply-body').innerHTML =
    ...
    (s === 1 && !!state.trackGKPerformance
      ? `<div class="ps-sec">` +
          ...
          `<button class="ps-pers-btn ps-btn-gk" onclick="psAction('GK Save')">` +
            `<span class="ps-pers-icon"><i class="fas fa-hand" style="font-size:.75em;display:inline-block;transform:scaleX(-1) rotate(-45deg);"></i><i class="fas fa-hand" style="font-size:.75em;display:inline-block;transform:rotate(45deg);"></i></span>` +
    ...
    `<div class="ps-sec">` +
      ...
      `<div class="ps-score-grid-sm">` +
        ...
        `<button class="ps-btn ps-btn-sm" onclick="psAction('Saved')"><span class="ps-btn-icon" style="display:inline-flex;gap:2px;align-items:center;"><i class="fas fa-hand" style="font-size:.75em;display:inline-block;transform:scaleX(-1) rotate(-45deg);"></i><i class="fas fa-hand" style="font-size:.75em;display:inline-block;transform:rotate(45deg);"></i></span><span class="ps-btn-lbl">Saved</span></button>` +
      `</div>` +
    `</div>` +
    // POSSESSION
    `<div class="ps-sec">` +
