...
const ACTION_META = {
  ...
  'Saved':       {cls:'action-btn-wide',icon:'<span style="display:inline-flex;gap:2px;align-items:center;"><i class="fas fa-hand" style="font-size:.8em;display:inline-block;transform:rotate(315deg);"></i><i class="fas fa-hand" style="font-size:.8em;display:inline-block;transform:rotate(45deg);"></i></span>'},
