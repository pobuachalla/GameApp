...
const appGlobals = {
  ...
  computeShotDots: 'writable',
  buildTurnoverDonut: 'writable',
...
export default [
  ...
  {
    // bundle.js is generated by build.cjs — lint the sources, not the artifact.
    // js/vendor/ is third-party code, loaded as its own <script> tag and never
    // concatenated into bundle.js — not ours to lint.
    ignores: ['js/bundle.js', 'js/vendor/**'],
  },
  {
    files: ['js/**/*.js'],
    languageOptions: {
